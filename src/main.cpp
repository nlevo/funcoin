...
uint256 hashGenesisBlock("0x46068f5c663f298b8f2225b6ff969f71054a11760101e2efcaed34f4e1019ac7");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xff002b911c353c5a0307e052ea7e3054b8a3a257193da41f29d8d8c783869e25");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04a68b3e5f90c32f80b157d7123f98d4dbf587e23b654b45129f4686d7be4df343c9367abd39f21e2b251341024c0678bffe5b1c8c1a8d8530c3b4d7933437f774") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1526591485;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084704956;

        if (fTestNet)
        {
            block.nTime    = 1526591427;
            block.nNonce   = 385400108;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x96f9a08d17b990559b1a91a62addd096878d8b2793a76b362491cdeadde27026"));
        block.print();
